...
ostream &testHelperRates(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os) {
    ...
    testPrinter(os, n, eps, lim, setRatio, counter, memberSetInitTime, nomSetInitTime,
                initTime, insertionTime, lookupTime, totalRunTime, h.getName());

    os << h;
}

ostream &testHelperFP(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os) {
    clock_t startRunTime = clock();
...
*/
    t0 = clock();
    HelperTPSetInit(lim, &h, &TNSet, shift, uni_size);
...
*/
    ...
    testPrinter(os, n, eps, lim, TNSetRatio, counter, memberSetInitTime, TNSetInitTime,
                initTime, insertionTime, lookupTime, totalRunTime, h.getName());
...
*/
    ...
    testPrinter(os, n, eps, n, memberSetRatio, counter, memberSetInitTime, 42,
                initTime, insertionTime, lookupTime, totalRunTime, h.getName());
...
ostream &testHelperTN(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os) {
    clock_t startRunTime = clock();
    set<string> memberSet, TNSet;//, naiveLookupSet;
...
ostream &testNonAdaptiveRates(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os) {
    clock_t startRunTime = clock();
    set<string> memberSet, nomSet;
...
ostream &testNonAdaptiveFP(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os) {
    clock_t startRunTime = clock();
    set<string> memberSet, TNSet;//, naiveLookupSet;
    ...
    t0 = clock();
    NonAdaptiveTPSetInit(lim, &h, &TNSet, shift, uni_size);
    double TNSetInitTime = (clock() - t0) / ((double) CLOCKS_PER_SEC);
    double TNSetRatio = TNSet.size() / (double) lim;
...
ostream &testNonAdaptiveTN(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os) {
    clock_t startRunTime = clock();
    set<string> memberSet, TNSet;//, naiveLookupSet;
...
ostream &
testPrinter(ostream &os, size_t n, double eps, size_t lim, double setRatio, int *counter, double memberSetInitTime,
            double nomSetInitTime, double initTime, double insertionTime, double lookupTime, double totalRunTime,
            const string name) {
    ...
    os << "nomSet to lim ratio : " << setRatio << endl << endl;
    ...
    cout << name << " lookupTime: " << lookupTime << "\t" << lim / lookupTime << " el/sec" << endl << endl;
    os << name << " lookupTime: " << lookupTime << "\t" << lim / lookupTime << " el/sec" << endl << endl;
