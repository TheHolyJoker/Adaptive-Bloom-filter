...
ostream &testHelperRates(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os = cout);

ostream &testHelperFP(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os = cout);

ostream &testHelperTP(size_t n, double eps, int shift, int uni_size, ostream &os = cout);

ostream &testHelperTN(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os = cout);


////NonAdaptiveHelper Tests


ostream &testNonAdaptiveRates(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os = cout);

ostream &testNonAdaptiveFP(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os = cout);

ostream &testNonAdaptiveTP(size_t n, double eps, int shift, int uni_size, ostream &os = cout);

ostream &testNonAdaptiveTN(size_t n, double eps, size_t lim, int shift, int uni_size, ostream &os = cout);
